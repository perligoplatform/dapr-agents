/**
 * Prompt templates for LLM orchestrator interactions.
 * 
 * PYTHON EQUIVALENT: dapr_agents/workflow/orchestrators/llm/prompts.py
 * 
 * Contains all the prompt templates used by the LLM orchestrator for:
 * - Task planning and breakdown
 * - Initial task briefing
 * - Next step decision making
 * - Progress checking and evaluation  
 * - Summary generation
 */

/**
 * Prompt for generating a structured execution plan.
 * PYTHON EQUIVALENT: dapr_agents/workflow/orchestrators/llm/prompts.py:1-44 (TASK_PLANNING_PROMPT)
 */
export const TASK_PLANNING_PROMPT = `## Task Overview
...
/**
 * Initial prompt to brief all agents about the task and execution plan.
 * PYTHON EQUIVALENT: dapr_agents/workflow/orchestrators/llm/prompts.py:46-57 (TASK_INITIAL_PROMPT)
 */
export const TASK_INITIAL_PROMPT = `## Mission Briefing
...
/**
 * Prompt for determining the next agent and step in the workflow.
 * PYTHON EQUIVALENT: dapr_agents/workflow/orchestrators/llm/prompts.py:59-81 (NEXT_STEP_PROMPT)
 */
export const NEXT_STEP_PROMPT = `## Task Context
...
/**
 * Prompt for checking progress and determining next actions.
 * PYTHON EQUIVALENT: dapr_agents/workflow/orchestrators/llm/prompts.py:83-124 (PROGRESS_CHECK_PROMPT)
 */
export const PROGRESS_CHECK_PROMPT = `## Progress Check
...
/**
 * Prompt for generating final task summary.
 * PYTHON EQUIVALENT: dapr_agents/workflow/orchestrators/llm/prompts.py:126-164 (SUMMARY_GENERATION_PROMPT)
 */
export const SUMMARY_GENERATION_PROMPT = `# Summary Generator
...
/**
 * Helper function to format prompt templates with parameters.
 * 
